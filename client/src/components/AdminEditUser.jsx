...
const AdminEditUser = () => {
  ...
  useEffect(() => {
    const fetchUser = async () => {
      try {
        const response = await axios.get(`https://car-rental-portal-backend.onrender.com/get-user/${id}`, { withCredentials: true });
  ...
  const handleSave = async () => {
    try {
      await axios.put(`https://car-rental-portal-backend.onrender.com/update-user/${id}`, user, { withCredentials: true });
