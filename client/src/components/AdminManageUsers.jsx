...
const AdminManageUsers = () => {
    ...
    const fetchUsers = async () => {
      try {
        const response = await axios.get(
          `https://car-rental-portal-backend.onrender.com/admin-manageprofile?page=${currentPage}&limit=${limit}&search=${searchTerm}`,
  ...
  const handleDelete = async (userId) => {
    ...
    try {
      await axios.delete(`https://car-rental-portal-backend.onrender.com/delete/${userId}`, {
        withCredentials: true,
      });
